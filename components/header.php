<link rel="stylesheet" href="//<?= $server; ?>/inc/css/bootstrap.min.css" />
<link rel="stylesheet" href="//<?= $server; ?>/inc/css/assets.css" />
<script src="//<?= $server; ?>/inc/js/jquery.min.js"></script>
<script src="//<?= $server; ?>/inc/js/bootstrap.min.js"></script>
