					...
					<div class="panel-body">
						<form id="editprofile" class="form-horizontal">
							<div class="form-group">
								<div class="col-lg-10">
									<input class="form-control" name="realName" value="<?= htmlentities($result['UserDetails']['Name']); ?>" placeholder="Real Name" style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%; cursor: auto;" type="text">
								</div>
							</div>
							<div class="form-group">
								<div class="col-lg-10">
									<input class="form-control" name="DCINumber" value="<?= htmlentities($result['UserDetails']['DCI']); ?>" placeholder="DCI Number" style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%; cursor: auto;" type="text">
									<br />
